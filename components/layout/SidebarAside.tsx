      ...
      <div className="p-3 border-b border-prism-border/50 shrink-0 flex flex-col gap-2.5">
        ...
        <nav className="flex flex-col gap-1 mt-1">
          ...
          <Link
            ...
            onClick={handleLinkClick}
          >
            <Brain size={15} className="shrink-0 text-prism-accent" />
        ...
        <>
          ...
          <div className="mx-3 mb-2 p-4 rounded-xl border border-prism-border bg-prism-accent/5 shadow-2xl flex flex-col gap-3.5 z-30 relative animate-in fade-in slide-in-from-bottom-2 duration-200">
            <div className="flex items-center justify-between border-b border-prism-border/50 pb-2">
              ...
              <span className="inline-flex items-center px-2 py-0.5 rounded-full text-4xs font-black uppercase tracking-wider bg-blue-100 text-blue-700 border border-blue-200 dark:bg-blue-950/65 dark:text-blue-300">
                Standard
              </span>
            </div>
            ...
            <div className="space-y-2.5">
              ...
              <p className="text-4xs font-semibold text-prism-muted leading-relaxed">
                Limits protect AI cost and response quality while payment integration is intentionally disabled.
              </p>
            </div>
          </div>
        </>
